...
export const translations = {
  zh: {
    ...
    'nav.expand': '展开导航',
    'nav.collapse': '收起导航',
    'navGroup.workspace': '工作台',
    'navGroup.models': '模型',
    'navGroup.gateway': '网关',
    'navGroup.agentsWorkflow': 'Agent / Workflow',
    'navGroup.memoryAssets': '知识与记忆',
    'navGroup.securityAdmin': '安全与管理',
    'navGroup.operationsEcosystem': '运维与生态',
  ...
  en: {
    ...
    'navGroup.agentsWorkflow': 'Agents / Workflow',
    'navGroup.memoryAssets': 'Knowledge & Memory',
    'navGroup.securityAdmin': 'Security & Admin',
    'navGroup.operationsEcosystem': 'Operations & Ecosystem',
