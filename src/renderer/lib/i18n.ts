...
export const translations = {
  zh: {
    ...
    'settings.noProvidersBody': '可以先体验 Demo Agent，或选择一个 preset 配置真实模型。',
  ...
  en: {
    ...
    'settings.noProvidersBody': 'Try the Demo Agent first, or choose a preset to configure a real model.',
